...
import { generateSampleTransactions } from './app/random_generators/transactions';
    ...
    <ng-container *ngIf="authService.isAuthenticated(); else authTemplate">
      <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="flex items-center gap-8">
              <div class="grid grid-cols-2 gap-4">
                <div class="text-lg">
                  Balance:
                  <span
                    [ngClass]="balance >= 0 ? 'text-green-600' : 'text-red-600'"
                    class="font-semibold"
                  >
          ...
          <app-add-transaction (addTransaction)="onAddTransaction($event)">
          </app-add-transaction>
    ...
    this.netWorth = this.transactions.reduce((acc, curr) => {
      switch (curr.type) {
        ...
        case "expense":
          return acc - curr.amount;
        case "lend":
          return acc + curr.amount; // Money lent is an asset
        case "borrow":
          return acc - curr.amount; // Money borrowed is a liability
        default:
          return acc;
      }
    }, 0);
